...
|--|--|--|--|
| MXQ PRO 4K 5G / MX9 | Rockchip RK322x | NAND | [Clique aqui](https://github.com/gugasabry/unboxing/blob/main/rk322x.md) |
...
- Verifique corretamente o processador da TV Box;
- Identifique se o armazenamento é NAND ou eMMC;
- Faça backup da ROM original;
- Utilize um SD Card confiável;
- Utilize fonte de alimentação estável;
